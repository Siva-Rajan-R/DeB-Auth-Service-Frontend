...
export const Hero = () => {
  ...
  return (
    <div className="relative h-100 flex flex-col justify-center items-center rounded-2xl mx-3 mt-30 max-sm:mt-10 max-lg:mt-15 border-l-1 border-r-1 border-cyan-300 overflow-hidden">
        ...
        <div className='w-240 text-center z-[90] max-sm:w-80'>
            ...
            <h2 className='text-[80px] max-sm:text-2xl max-lg:text-3xl max-sm:mb-2 max-lg:mb-2 bg-linear-to-r from-cyan-100 via-cyan-200 to-cyan-300 bg-clip-text text-transparent font-bold'>

...
export const FeaturesCard = ({title,description,imageUrl,lottieUrl}) => {
  return (
    <div className='shadow shadow-purple-300 w-100 max-sm:w-full max-lg:w-90 h-40 max-sm:h-30 max-lg:h-30 rounded-2xl flex justify-between max-sm:scale-100 max-lg:scale-80'>
